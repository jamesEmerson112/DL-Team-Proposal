...
| 29 | **Cross-Sequence Attention** | PG competition technique | Attend across sequence boundaries in deepest 3-4 layers during evaluation | **Proven** — ranks 14,15 (1.1307) | Eval-time only trick, no training change. Partial XSA on last 3-4 layers. High priority since validated by top submissions. |
