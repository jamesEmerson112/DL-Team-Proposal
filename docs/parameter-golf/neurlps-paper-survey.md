...
| 22 | **Peri-LN** | ICML 2025 | [arxiv](https://arxiv.org/abs/2502.02732) | Normalizes both input AND output of each sublayer; constrains residual spikes | Not tested (paper read) | Zero extra params, just rearranging norm placement. Stabler gradients = faster convergence. Easy A/B test. |
